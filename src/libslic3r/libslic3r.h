...
#define SLIC3R_APP_FULL_NAME "Confabric Slicer"
#define GCODEVIEWER_APP_NAME "Confabric Slicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "ConfabricSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("Confabric Slicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
