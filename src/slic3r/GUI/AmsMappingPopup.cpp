...
void AmsReplaceMaterialDialog::create()
{
    ...
    identical_filament->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#f6cc1d")));
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(212, 173, 10), StateColor::Pressed), std::pair<wxColour, int>(wxColour(246, 204, 29), StateColor::Normal));
