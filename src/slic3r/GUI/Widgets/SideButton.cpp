    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(212, 173, 10), StateColor::Pressed);
    border_color.append(wxColour(255, 220, 80), StateColor::Hovered);
    border_color.append(0xf6cc1d, StateColor::Normal);
    ...
    background_color.append(wxColour(212, 173, 10), StateColor::Pressed);
    background_color.append(wxColour(255, 220, 80), StateColor::Hovered);
    background_color.append(0xf6cc1d, StateColor::Normal);
